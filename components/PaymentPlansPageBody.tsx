    ...
    <main>
      ...
      <section className="bg-bg-tinted">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <Reveal delay={0.1} className="mt-10 overflow-hidden rounded-2xl border border-surface-border bg-white p-2 shadow-[0_24px_60px_-38px_rgba(1,36,83,0.3)] sm:p-4">
            <CherryWidget />
          </Reveal>
        </div>
      </section>
