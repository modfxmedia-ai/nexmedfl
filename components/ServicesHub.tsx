          ...
          {SERVICES_GRID.map((service, i) => {
            ...
            return (
              <Reveal key={service.href} delay={i * 0.06}>
                <Link
                  href={service.href}
                  className="group/card flex h-full flex-col overflow-hidden rounded-2xl border border-surface-border bg-white shadow-[0_20px_50px_-32px_rgba(20,121,232,0.35)] transition-all hover:-translate-y-1 hover:shadow-[0_28px_60px_-28px_rgba(20,121,232,0.45)]"
                >
